...
// 列表轮播图
exports.getBanner = getBanner;var getListBanner = function getListBanner(data) {
  return _interface.default.request({
    url: 'tongcheng/v2/findNews',
    method: 'GET',
    data: data });
...
// 列表商家信息
exports.getListBanner = getListBanner;var getListShop = function getListShop(data) {
  return _interface.default.request({
    url: 'tongcheng/v2/findNews',
    method: 'GET',
    data: data });
...
// 星级评分
exports.getListShop = getListShop;var getStar = function getStar(ids) {
  return _interface.default.request({
...
{
  config: {
    baseUrl: "https://tool.changbaishan.gov.cn/",
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getImgSrc = void 0; /*
                                                                                                       	图片格式转化
                                                                                                       	@param imgSrc 图片路径
...
var getImgSrc = function getImgSrc(imgSrc, num) {
